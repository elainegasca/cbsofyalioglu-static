...
export default function Blog({ posts }) {
    ...
    const description =
        "Kişisel blog. Çoğunlukla web üzerine yazılar ve dijital araçlar.";
    return (
        <div className="min-h-screen">
            <Head>
                <Head>
                    <title key="h-title-tag">
                        Design &amp; Development | Can Burak Sofyalıoğlu
                    </title>
    ...
    const posts = files
        .map((filename) => {
            ...
            if (
                ...
                frontMatter.language.toLowerCase() === "tr"
            ) {
                //console.log("Turkish")
                return {
                    frontMatter,
