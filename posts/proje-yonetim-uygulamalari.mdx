...
### [ClickUp](https://clickup.com/?fp_ref=can43)
...
![Linear issue tracker](/posts/proje-yonetim-araci-linear-1270x510.webp)


Linear daha çok bir sorun takip etme yazılımı (*issue tracker*) diyebiliriz. Bir **Jira alternatifi** diyebiliriz Linear için. Bir proje yönetimi sorun takip etme programı olarak Linear'ın GitHub, GitLab, Zendesk, Slack gibi bir çok entegrasyonu mevcut.

California'dan çıkan bu *dijital görev takip aracı* harikulade güzel ve temiz bir arayüze sahip. Linear, kullanıcı deneyimi konusunda da çok başarılı bir araç. Tamamen klavye ile uygulamayı yönetmeniz mümkün, detaylar için [Linear dokümantasyon sayfası](https://linear.app/docs)'na bakabilirsiniz.

Linear ile bir issue (~sorun) oluşturuyor ve bu sorun'a durum (todo, in-progress, done gibi), aciliyet (urgent, high, medium, low) ve tarih ekleyebiliyorsunuz. Ayrıca her issue için alt issue'lar yaratıp takibini gerçekleştirebiliyorsunuz.

![Linear app](/posts/linear.webp)
