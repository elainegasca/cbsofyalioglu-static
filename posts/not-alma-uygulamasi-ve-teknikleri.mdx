...
Ayrıca bu not alma uygulamaları listesinde her sayfada denk gelebileceğiniz, klasik uygulamalar olan Evernote, OneNote gibi uygulamalardan ziyade az bilinen ve de yeni kullanıma sunulan app'lerden bahsedeceğim.
...
Dijital not tutma ve bilgi düzenleme araçlarının sayısı her geçen gün artıyor. Her yeni uygulamayı denerken yeni bir oyuncak denemiş gibi oluyorum. Bir kaç konu dışı uygulama başlığı daha var böyle hissettiğim.

Daha sonradan fark ettim ki bu duruma Shiny Toy/Object Syndrome deniliyormuş [\[6\]\[7\]](https://www.cbsofyalioglu.com/not-alma/not-alma-uygulamasi-ve-teknikleri/#references). Harika.

Dipnot: Burada paylaşilan linklerin bir kısmı affiliate linkler olabilmektedir.

### Not Alma Uygulamaları

#### [Supernotes](https://my.supernotes.app?signup=1&invite=SbIyBt)

<ImageZoom
    src="/posts/not-alma/supernotes.webp"
    width={1400}
    height={720}
    alt="Supernote uygulaması"
/>

Notlarınızı mini-card'lara yazmanızı sağlayan kullanıcı arayüzü hoş olan bir not alma programı Supernotes. Harikulade bir arayüze sahip.

Minicard'lar şeklinde kaydettiğiniz notlarınızı birbirleriyle ilişkilendirebilir ve graph-map üzerinde görebilirsiniz.

####  [Tana Not Uygulaması](https://tana.inc)

<ImageZoom
    src="/posts/tana-not-alma-uygulamasi.webp"
    width={1535}
    height={716}
    alt="Tana Not Uygulaması"
/>
Tana henüz kapalı beta aşamada olan ilginç ve bir o kadar da popüler hale gelmecek olan bir uygulama.

**Tana not uygulaması**, süper etiket (supertag) özelliği ile öne çıkan bir outliner not alma uygulamasıdır.

Supertag'ler gayet basit bir kullanım ile gelip güçlü bir etki yaratacak bir özellik gibi gözükmekte.

En basit haliyle şuınu diyebilirim: aldığınız notlarınıza etiket ekleyerek, notlarınıza yeni özellikler katabiliyorsunuz.

Örneğin kişi etiketine yeni bir özellik ekliyorsunuz: Doğum tarihi diyelim. Böylece kişi etiketine sahip her maddeniz  doğum tarihi özelliğine sahip oluyor.

####  [Agenda](https://agenda.com)

<ImageZoom
    src="/posts/agenda-not-uygulamasi.webp"
    width={1535}
    height={716}
    alt="Agenda not uygulaması"
/>

**Agenda not uygulaması** yalnızca Apple ekosistemindeki cihazlarla çalışabilen bir dijital araç.
Takviminizle entegre çalışabilen bir uygulama. Takviminize not ekleyebilir, notlarınızı takviminize ekleyebilirsiniz.
Kişisel olarak kullandığım not araçlarından biri olduğu notunu eklemeliyim.


####  [Notion](https://affiliate.notion.so/jowm9ylyek7b)
...
<ImageZoom
    src="/posts/anytype-not-uygulamasi.webp"
    width={1400}
    height={800}
    alt="Anytype not uygulaması"
/>

Yaklaşık iki senedir sınırlı sayıda kullanıcı alarak geliştirilen ve blockchain tabanlı bir uygulama Anytype. Tam olarak not uygulaması diyemiyorum, üstün yeteneklerinden dolayı. Sık kullanılanlara eklemekte fayda var.

Bu uygulamayı yenice kullanma fırsatına eriştim. İlk başlarda kullanımı biraz zor gelse de game-changer potansiyeli taşıdığı çok açık.

Anytype sıklıkla aradığım bir özelliğe sahip: Metaprogramming.

##### Metaprogramlama Nedir?
Metaprogramming, bir programın kendisini değiştirmesine olanak sağlayan bir programlama paradigması.

Bir diğer şekilde söylersek size sunulan data yapısını değiştirmenize olanak sağlıyor. Mesela Kişi adında bir data tipi yaratmanıza ve bunu diğer data tipleri ile etkinleştirmenize izin veriyor.
Örneğin Bir kişi datasını bir etkinlik datası ile ilişkilendiribiliyorsunuz. Böylece isim-soyisim ve diğer bilgilerine sahip olduğunuz arkadaşınızla belirli bir tarih özelliğine sahip etkinlik datasıyla ilişkilendiriyorsunuz. Bu da bilgi yönetmeyi inanılmaz zengin bir hale getiriyor.

Ayrıca [Telegram](https://t.me/anytype) gruplarında çok aktifler, topluluk ile iletişimleri buradan dönüyor.

#### [Acreom](https://acreom.com)
Acreom hem takviminizi hem de görevlerinizi yönetebileceğiniz, kendi data şablonlarınızı oluşturmanıza izin veren bir diğer çoklu platform uygulaması.
...
Craft nispeten yeni olan ve yalnızca Apple cihazlar ile kullanılabilen bir uygulama. Ek olarak web uygulaması şeklinde de kullanabileceğinizi belirtelim.
...
#### [One Note](https://www.microsoft.com/tr-tr/microsoft-365/onenote/digital-note-taking-app)
